                         ...
                         //  Image.asset('asset/avatar-stack-preview.png',height: 100,width: 150,),
                          Container(
                            child: Row(mainAxisAlignment:MainAxisAlignment.spaceEvenly ,
                              children: [
                                Image.asset('asset/avatar-stack-preview.png',height: 100,width: 150,),
                                Image.asset('asset/liner_nw-removebg-preview.png',height: 70,width: 100,),
                              ],
                            ),
                          )
                         ],
                 ...
                 child: Card(
                   child: Container(
                     child: ListTile(
                       ...
                       leading: Image.asset('asset/hexa1.jpg',height: 25,width: 25,),
                 ...
                 child: Card(
                   child: Container(
                     child: ListTile(
                       ...
                       leading:Image.asset('asset/square2.jpg',height: 25,width: 25,),
                   ...
                   child: Container(
                     child: ListTile(
                      shape: RoundedRectangleBorder(
                       ...
                       leading: Image.asset('asset/hexa2.jpg',height: 25,width: 25),
                       title: Text("UI Design",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold
                           ,color: Colors.indigo),),
                       subtitle: Text("09:00 AM - 11:00 AM"),
                       trailing: Icon(Icons.arrow_forward_ios_rounded,size: 15,color: Colors.indigo,),
                 ...
                 child: Card(
                   child: Container(
                     child: ListTile(
                       ...
                       leading: Image.asset('asset/hexa3.jpg',height: 25,width: 25),
                       title: Text("UI Design",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold ),),
                       subtitle: Text("09:00 AM - 11:00 AM"),
                       trailing: Icon(Icons.arrow_forward_ios_rounded,size: 15,color: Colors.indigo,),
